...
class MessagingAPITest(TestCase):
    """Basic API tests for messaging endpoints.

    These tests verify that only group members can list/post messages and
    that message creation and retrieval behave as expected.
    """
    def setUp(self):
